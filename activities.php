			...
			<div class="row justify-content-center">
				<div class="col-md-4">
					<div class="services-box restaurant text-center">
						<img src="img/activites/icon1.png" alt="">
						<h5 class="mt-3"> Golf Club </h5>
						<p class="mt-3">  play golf on beach with proper golf ground and beatiful view  </p>
						
					</div>
				</div>
				<div class="col-md-4 mt-5 mt-md-0">
					<div class="services-box restaurant text-center">
						<img src="img/activites/icon2.png" alt="">
						<h5 class="mt-3">  Jet ski  </h5>
						<p class="mt-3"> best quality jet ski with life jaket and all acceries </p>
						
					</div>
				</div>
				<div class="col-md-4 mt-5 mt-md-0">
					<div class="services-box restaurant text-center">
						<img src="img/activites/icon3.png" alt="">
						<h5 class="mt-3"> Flying Board</h5>
						<p class="mt-3">best quality flyingborad with life jaket and all acceries </p>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 align-self-center">
					...
					<h3 class="text-center padding-bottom-small">Our Activities </h3>
				</div>
				<div class="section clearfix"></div>
				<div class="col-md-6" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
					<div class="restaurant-box">
						<img src="img/activites/pic1.jpg" alt="">
						<h6><span>Jet Ski</span></h6>
						<p><span>best quality jet ski with life jaket. </span></p>
						<!-- <h5><span>$32</span></h5> -->
					</div>
				</div>
				<div class="col-md-6 mt-4 mt-md-0" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.4s">
					<div class="restaurant-box">
						<img src="img/activites/pic3.jpg" alt="">
						<h6><span> Golf culb at beach </span></h6>
						<p><span> play golf on beach and beatiful view   </span></p>
						<!-- <h5><span>$47</span></h5> -->
					</div>
				</div>
				<div class="col-md-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
					<div class="restaurant-box">
						<img src="img/activites/pic5.jpg" alt="">
						<h6><span> flyingborad</span></h6>
				...
				<div class="col-md-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.4s">
					<div class="restaurant-box">
						<img src="img/activites/pic7.jpg" alt="">
						<h6><span> Esports game</span></h6>
						<p><span> all kind of esports game available</span></p>
						<!-- <h5><span>$64</span></h5> -->
					</div>
				</div>
			</div>
