<?php include 'includes/header.php'?>
	...
	<div class="section padding-top-bottom over-hide" data-aos="fade-up">
		<div class="container">
			<div class="row">
				<div class="col-md-6 align-self-center">
					<div class="row justify-content-center">
						<div class="col-10">
							<div class="subtitle text-center mb-4">Royal Gate Resort</div>
	...
	<div class="section background-grey over-hide">
		<div class="container-fluid px-0">
			<div class="row mx-0">
				<div class="col-xl-6 px-0" data-aos="fade-left">
				...
				<div class="col-xl-6 px-0 mt-4 mt-xl-0 align-self-center">
					<div class="row justify-content-center">
						<div class="col-10 col-xl-8 text-center" data-aos="fade-right">
			...
			<div class="row mx-0">
				<div class="col-xl-6 px-0 mt-4 mt-xl-0 pb-5 pb-xl-0 align-self-center" data-aos="fade-left">
					<div class="row justify-content-center">
				...
				<div class="col-xl-6 px-0 order-first order-xl-last mt-5 mt-xl-0" data-aos="fade-right">
	...
	<div class="section background-dark over-hide">
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 pt-4 pt-sm-0" data-aos="fade-left">
					<a href="services.html">
						<div class="img-wrap services-wrap">
				...
				<div class="col-sm-6 col-lg-4 pt-4 pt-lg-0" data-aos="fade-down">
					<a href="services.html">
						<div class="img-wrap services-wrap">
				...
				<div class="col-sm-6 col-lg-4 pt-4 pt-lg-0" data-aos="fade-right">
					<a href="services.html">
						<div class="img-wrap services-wrap">
	...
	<div class="section padding-top-bottom over-hide">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 align-self-center" data-aos="fade-left">
				...
				<div class="col-sm-6 col-lg-4 mt-5 mt-sm-0" data-aos="flip-down">
					<div class="services-box text-center">
				...
				<div class="col-sm-6 col-lg-4 mt-5 mt-lg-0" data-aos="flip-right">
					<div class="services-box text-center">
				...
				<div class="col-sm-6 col-lg-4 mt-5" data-aos="flip-left">
					<div class="services-box text-center">
				...
				<div class="col-sm-6 col-lg-4 mt-5" data-aos="flip-up">
					<div class="services-box text-center">
				...
				<div class="col-sm-6 col-lg-4 mt-5" data-aos="flip-right">
					<div class="services-box text-center">
	...
	<div class="section padding-top-bottom-big over-hide">
		...
		<div class="section z-bigger">		
			<div class="container">
				<div class="row">
					<div class="col-md-12 py-5" data-aos="zoom-in">
	...
	<div class="section padding-top-bottom over-hide background-grey">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 align-self-center" data-aos="zoom-in">
				...
				<div class="col-md-6 mt-4 mt-md-0" data-aos="flip-right">
					<div class="room-box background-white">
				...
				<div class="col-md-6 mt-4" data-aos="flip-left">
					<div class="room-box background-white">
				...
				<div class="row justify-content-center">
					<div class="col-md-8" data-aos="fade">
						<div id="owl-sep-1" class="owl-carousel owl-theme">								 
							...
							<div class="item">					
								<div class="quote-sep">
									<h4>"Every good day starts off with a cappuccino, and there's no place better to enjoy some frothy caffeine than at the Royal Resort."</h4>
									<h6>Terry Mitchell</h6>	
								</div>									
							</div>											
							<div class="item">					
								<div class="quote-sep">
									<h4>"I still enjoy traveling a lot. I mean, it amazes me that I still get excited in Resort rooms just to see what kind of shampoo they've left me."</h4>
	...
	<div class="section padding-top-bottom background-grey over-hide">
		<div class="container">
			...
			<div class="row background-white p-0 m-0">
				<div class="col-xl-6 p-0" data-aos="fade-left">
			...
			<div class="row background-white p-0 m-0">
				<div class="col-xl-6 p-0 align-self-center" date-aos="fade-left">
					<div class="row justify-content-center" >
						<div class="col-9 pt-4 pt-xl-0 pb-5 pb-xl-0 text-center" >
				...
				<div class="col-xl-6 order-first order-xl-last p-0" date-aos="fade-right">
	...
	<div class="section padding-top z-bigger">
		<div class="container">
			<div class="row justify-content-center padding-bottom-smaller">
				<div class="col-md-8" data-aos="zoom-out">
				...
				<div class="section clearfix"></div>
				<div class="col-md-8 text-center mt-5" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s" data-aos="fade-up-left">
