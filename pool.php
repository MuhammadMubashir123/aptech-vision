			...
			<div class="row justify-content-center">
				<div class="col-md-4">
					<div class="services-box restaurant text-center">
						<img src="img/pool/download.png" alt="">
						<h5 class="mt-3" > Natare Pool </h5>
						<p class="mt-3"> Natare pools are fully customizable, featuring a wide range of shapes, sizes </p>
						<!-- <a class="mt-1 btn btn-primary" href="services.html">read more</a> -->
					</div>
				</div>
				<div class="col-md-4 mt-5 mt-md-0">
					<div class="services-box restaurant text-center">
						<img  src  ="img/pool/icon2.png  "  >
						<h5 class="mt-3"> Swimming compition </h5>
						<p class="mt-3">Sed ut perspiciatis unde omnis iste natus  sit, totam rem aperiam.</p>
						<!-- <a class="mt-1 btn btn-primary" href="services.html">read more</a> -->
					</div>
				</div>
				<div class="col-md-4 mt-5 mt-md-0">
					<div class="services-box restaurant text-center">
						<img src="img/pool/icon3.png" alt="">
						<h5 class="mt-3"> Kids pool </h5>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 align-self-center">
					<h3 class="text-center padding-bottom-small">Our Resort Pool </h3>
				</div>
				<div class="section clearfix"></div>
				<div class="col-md-6" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
					<div class="restaurant-box">
						<img src="img/pool/image.jpg" alt="">
						<h6><span> Resort Main Pool </span></h6>
						<p><span> best swimming experience</span></p>
						
					</div>
				</div>
				<div class="col-md-6 mt-4 mt-md-0" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.4s">
					<div class="restaurant-box">
						<img src="img/pool/image2.jpg" alt="">
						<h6><span> Luxury Beach Pool </span></h6>
						<p><span>  fantastic view point  </span></p>
						
					</div>
				</div>
				<div class="col-md-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
					<div class="restaurant-box">
						<img src="img/pool/image3.jpg" alt="">
						<h6><span> pool smoll harts  </span></h6>
						<p><span>bungalow near endless pool over sea</span></p>
